...
Adding a new disk in the storage is pretty easy. The only things I did were to copy and paste code from the documentation and made it easy: https://laravel.com/docs/filesystem#custom-filesystems
